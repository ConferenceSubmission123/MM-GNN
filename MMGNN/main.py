...
if __name__ == '__main__':
    ...
    ap.add_argument('--mode', type=str, default='mean', help='mode to combine different moments feats')
    ...
    ap.add_argument('--use_adj_norm', action='store_true', help='whether use adj normalization(row or symmetric norm).')
    ...
    for train_id in range(1, 1+args.repeat):
        ...
        # build datasets
        dataset, data_split = build_dataset(args, transform=None)
        # data_split=None
        data = dataset[0]
    ...
    if log_results:
        if args.model in ['MM_SAGE', 'GraphSAGE']:
            # f_path = './res/MMSAGE_optimize_exp_facebook100_3x3_train10%_final_v2.csv'
            f_path = './res/Ablation2_exp_facebook100_train60%_v0.csv'
        else:
            f_path = './res/Baseline_SOTA_exp_facebook100_3x3_train60%_v2.csv'
